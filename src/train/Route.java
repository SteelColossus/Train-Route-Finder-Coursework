...
public class Route
{
     ...
     *            this route
     */
    public Route(Station[] stations, int totalMins, int singlePounds, int singlePennies, int returnPounds,
                 int returnPennies)
    {
     ...
     *            this route
     */
    public Route(Station start, Station end, int totalMins, int singlePounds, int singlePennies, int returnPounds,
                 int returnPennies)
    {
    ...
    /**
     * Get the stop in this route with the given index. A stop ignores the
