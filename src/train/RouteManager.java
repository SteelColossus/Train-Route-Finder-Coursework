...
public class RouteManager
{
    ...
    /**
     * Get the route in the array with the given starting and ending station
     * names.
     * 
    ...
    /**
     * Add a new station with the given name and main value into the station
     * array.
     * 
     * @param name the name of the station
     ...
     * @param singlePounds the number of pounds only for a single ticket for
     *            this route
     * @param singlePennies the number of pennies only for a single ticket for
     *            this route
     * @param returnPounds the number of pounds only for a return ticket for
     *            this route
     * @param returnPennies the number of pennies only for a return ticket for
     *            this route
     * @return the route that was added
     */
    ...
    /**
     * Updates the file at a given path to contain the current data contained
     * within RouteManager.
     * 
    ...
    /**
     * Updates the RouteManager data to the route data loaded from a file at a
     * given path
     * 
